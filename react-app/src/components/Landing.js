...
import './Landing.css';
import alias from '../assets/find-trails.mp4';
...
const Landing = () => {
    ...
    return (
            ...
            <div className="landing-content">
                <video src={alias} autoPlay loop muted className="landing-video" />
                    <h1 className="landing-title">Discover Your Next Adventure</h1>
                    <p className="landing-subtitle">Explore hiking trails across all 50 states</p>
